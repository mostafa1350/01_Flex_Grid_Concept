  ...
  return (
    <div className='h-screen bg-no-repeat m-0 p-0 bg-cover bg-center bg-ChalpeyLight dark:bg-ChalpeyDark'>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <div className='flex w-full flex-col my-10 sm:flex-row md:flex-row lg:flex-col xl:flex-col 2xl:flex-row'>
            <div className='flex w-full bg-blue-300/50 sm:bg-yellow-300/50 md:bg-red-500/70 lg:bg-yellow-800/55 lg:w-full h-[80px] '>div1</div>
            <div className='flex w-full bg-blue-300/50 sm:bg-yellow-300/50 md:bg-red-500/70 lg:bg-yellow-800/55 lg:w-full h-[80px] '>div2</div>
            <div className='flex w-full bg-blue-300/50 sm:bg-yellow-300/50 md:bg-red-500/70 lg:bg-yellow-800/55 lg:w-full h-[80px] '>div3</div>
            <div className='flex w-full bg-blue-300/50 sm:bg-yellow-300/50 md:bg-red-500/70 lg:bg-yellow-800/55 lg:w-full h-[80px] '>div4</div>
